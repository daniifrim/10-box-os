...
def generate_completion_message(conversation_context=None):
    """
    Generate a completion message with task summary using Anthropic LLM.
...
Requirements:
- Start with what was accomplished (e.g., "Created user login system", "Fixed database connection", "Added dark mode toggle")
